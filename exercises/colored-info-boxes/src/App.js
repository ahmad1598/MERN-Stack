...
function App(){
    ...
    return(
        <div>
            <Box style = {"#00b5cc"} title = {"This is my title"} subtitle = {titleObj1.Subtitle} information = {titleObj1.Information} />
            <Box style = {"#336e7b"} title = {titleObj2.title} subtitle = {titleObj2.Subtitle} information = {titleObj2.Information} />
            <Box style = {"#34495e"} title = {titleObj3.title} subtitle = {titleObj3.Subtitle} information = {titleObj3.Information} />
            <Box style = {"#22a7f0"} title = {titleObj4.title} subtitle = {titleObj4.Subtitle} information = {titleObj4.Information} />
            <Box style = {"#6bb9f0"} title = {titleObj5.title} subtitle = {titleObj5.Subtitle} information = {titleObj5.Information} />
            <Box style = {"#1f3a93"} title = {titleObj6.title} subtitle = {titleObj6.Subtitle} information = {titleObj6.Information} />
            <Box style = {"#446cb3"} title = {titleObj7.title} subtitle = {titleObj7.Subtitle} information = {titleObj7.Information} />
            <Box style = {"#4b77be"} title = {titleObj8.title} subtitle = {titleObj8.Subtitle} information = {titleObj8.Information} />
            <Box style = {"#5c97bf"} title = {titleObj9.title} subtitle = {titleObj9.Subtitle} information = {titleObj9.Information} />
